...
def get_config():
    conf = {
        ...
        "audio_file": "./source/music/collection1",
        "output_dir": "./out/",
        "news_duration": 7,
        "intro_duration": 2,
        "max_str_length": 25,
...
def get_drawtext_introtext(start, duration, text):
...
def run(news):
    conf = get_config()
    news_time = News.get_news_time('usa')
    ...
    dt_introtext2 = get_drawtext_introtext(0, conf['intro_duration'], conf['intro_text'])
